...
def FCN_Vgg16_16s(input_shape=None, batch_shape=None, classes=21):
    if batch_shape:
    ...
    x = Conv2D(256, (24, 24), activation='relu', padding='same', name='fc1')(x)
    # x = Dropout(0.5)(x)
    ...
    x   = Conv2DTranspose(classes,    kernel_size=(4,4),  strides=(4,4), use_bias=False, name='upsample_2', data_format='channels_last' )(x)
    x = Reshape((image_size[0]*image_size[1]*classes,1))(x)
